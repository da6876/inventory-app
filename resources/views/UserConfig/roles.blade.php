                ...
                <div class="card">
                    <div class="card-body border-bottom">
                        <div class="d-flex justify-content-between align-items-center flex-wrap">
                            <h6 class="mb-2 mb-md-0 text-uppercase fw-medium">Roles</h6>
...
@section('script')
    ...
    <script>
        ...
        $(document).ready(function () {
                ...
                columns: [
                    ...
                    {data: 'name'},
                    {
                        ...
                        render: function (data, type, row) {
                            return `
                                <button type="button" class="btn btn-outline-success btn-sm btn-icon-text permission-btn" data-id="${row.id}">Permission<i class="typcn typcn-edit btn-icon-append"></i></button>
            ...
            $('#usersTable tbody').on('click', '.permission-btn', function () {
                var id = $(this).data('id');
                alert(id);
            });
